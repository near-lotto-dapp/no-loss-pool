...
export const translations: Record<Language, any> = {
    ua: {
        ...
        welcomeUser: "Ласкаво просимо до вашого облікового запису",
        logoutBtn: "Вийти",
        ...
        hwStep2Title: "2. Миттєвий Cloud Wallet",
        hwStep2Desc: "Ніяких сід-фраз чи складних налаштувань. Безпечний гаманець NEAR автоматично створюється під час реєстрації. Ваші приватні ключі зашифровані та надійно зберігаються у хмарі.",
        ...
        cloudWalletTitle: "Private Wallet",
        ...
        wallet_types: {
            custodial_title: "Cloud Wallet (Custodial)",
            custodial_desc: "Керується JOMO для максимальної простоти. Захищений 2FA та професійною інфраструктурою. Ми дбаємо про безпеку ваших ключів у хмарі.",
            non_custodial_title: "Private Wallet (Non-Custodial)",
            non_custodial_desc: "Ви маєте повний контроль над своїми ключами. Вони зберігаються лише у вас. Примітка: JOMO не може відновити ваші кошти, якщо ви втратите seed-фразу та пароль.",
            tab_cloud: "Cloud",
            tab_private: "Private",
...
5. Відповідальність: Платформа не несе відповідальності за втрату коштів внаслідок компрометації ваших облікових даних (пароля, 2FA).`
    ...
    en: {
        ...
        createAccount: "Create secure vault",
        ...
        loginTitle: "Log In to secure vault",
        loginBtn: "Log In",
        loginSuccess: "Login successful!",
        loginError: "Invalid email or password.",
        haveAccount: "Already have an vault?",
        noAccount: "Don't have an account?",
        welcomeUser: "Welcome to your secure vault",
        logoutBtn: "Log Out",
        ...
        copied: "Copied!",
        enterCabinetBtn: "Your secure vault",
        ...
        accountRecoveryTitle: "Vault Recovery",
        ...
        hwStep2Title: "2. Instant Cloud Wallet",
        hwStep2Desc: "No seed phrases, no complex setups. A secure NEAR wallet is auto-generated the moment you sign up. Your private keys are encrypted and safely managed in the cloud.",
...
5. Liability: The platform is not liable for loss of funds due to the compromise of your credentials (password, 2FA).`
    ...
    es: {
        ...
        hwStep2Title: "2. Cloud Wallet Instantánea",
        hwStep2Desc: "Sin frases semilla, sin configuraciones complejas. Se genera automáticamente una billetera NEAR segura en el momento de registrarte. Tus claves privadas están cifradas de forma segura en la nube.",
        ...
        wallet_types: {
            custodial_title: "Cloud Wallet (Custodia)",
            custodial_desc: "Gestionada por JOMO para máxima simplicidad. Protegida por 2FA e infraestructura profesional. Nosotros nos encargamos de la seguridad en la nube.",
            non_custodial_title: "Private Wallet (No Custodia)",
