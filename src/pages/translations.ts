...
export const translations: Record<Language, any> = {
    ua: {
        ...
        landingSubtitle: "Joy Of Missing Out: Твій капітал працює безпечно з блокчейном AI Near Protocol.",
        ...
        insufficientBalanceError: "Недостатньо коштів. У вас недостатньо NEAR.",
    ...
    en: {
        ...
        copied: "Copied!",
        landingSubtitle: "Joy Of Missing Out: Your capital works securely with the AI Near Protocol blockchain.",
        ...
        insufficientBalanceError: "Insufficient balance. You don't have enough NEAR.",
    ...
    es: {
        ...
        landingSubtitle: "Joy Of Missing Out: Tu capital trabaja de forma segura con el blockchain AI Near Protocol.",
        ...
        insufficientBalanceError: "Saldo insuficiente. No tienes suficiente NEAR.",
