...
export const translations: Record<Language, any> = {
    ua: {
        ...
        homeBtn: "Назад",
        warning: "Увага",
        activeUnstakeWarning: "У вас вже є активний запит на розстейк. Будь ласка, дочекайтеся таймера та натисніть 'Забрати свої монети', перш ніж виводити нові кошти.",
    ...
    es: {
        ...
        homeBtn: "Volver",
        warning: "Atención",
        activeUnstakeWarning: "Ya tienes una solicitud de unstake activa. Por favor, espera a que termine el temporizador y presiona Claim antes de retirar nuevos fondos.",
