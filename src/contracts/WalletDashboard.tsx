...
export function WalletDashboard({ user, t, onLogout }: WalletDashboardProps) {
    ...
    return (
        <div className="w-100 animate__animated animate__fadeIn">
            ...
            {/* ========================================== */}
            {/* 1. CUSTODIAL WALLET BLOCK (Active)           */}
            {/* ========================================== */}
            <div className="p-4 bg-dark rounded mb-4 border border-secondary text-start position-relative">

                <div className="d-flex justify-content-between align-items-center mb-3">
                    <div>
                        <h5 className="text-white m-0 d-inline-block me-2">{t.wallet_types?.custodial_title || "Custodial Wallet"}</h5>
                        ...
                        <div className="d-flex flex-column align-items-center justify-content-center gap-2 py-2 mx-auto w-100">
                            ...
                            >
                                {isGeneratingWallet ? (
                                    ...
                                    <><i className="bi bi-arrow-clockwise me-1"></i> Regenerate Wallet</>
                                )}
                            </button>
                        </div>
                    )}
                ...
                <button
                    ...
                    disabled={!walletAddress}
                >
                    <i className="bi bi-layers me-2"></i>{t.actions?.stake || t.stakeBtn}
                </button>
            ...
            {/* ========================================== */}
            {/* 2. NON-CUSTODIAL (CLOUD) WALLET BLOCK      */}
            {/* ========================================== */}
            <div className="p-4 bg-dark rounded mb-4 border border-secondary text-center position-relative opacity-50" style={{ filter: 'grayscale(0.6)' }}>
                <div className="d-flex flex-column align-items-center mb-3 gap-2">
                    ...
                    <h5 className="text-white m-0">{t.wallet_types?.non_custodial_title || "Cloud Wallet (Non-Custodial)"}</h5>
                </div>
                ...
                <div className="p-2 mx-auto rounded border border-danger-subtle bg-danger-subtle text-danger small d-inline-block" style={{fontSize: '0.75rem'}}>
                    ...
                    <strong>{t.wallet_types?.security_note_title || "Security"}:</strong> {t.wallet_types?.security_note_desc || "Loss of password = loss of funds."}
                </div>
            </div>

            <button onClick={onLogout} className="btn btn-outline-danger w-100 fw-bold mt-2 mb-4">
